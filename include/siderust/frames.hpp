 ...
 *
 * Default: (longitude, latitude).  Specialise per-frame for RA/Dec, Az/Alt,
 * etc.
 */
template <typename F> struct SphericalNaming {
  static constexpr const char *lon_name() { return "longitude"; }
  static constexpr const char *lat_name() { return "latitude"; }
};

template <> struct SphericalNaming<ICRS> {
  static constexpr const char *lon_name() { return "right_ascension"; }
  static constexpr const char *lat_name() { return "declination"; }
};

template <> struct SphericalNaming<ICRF> {
  static constexpr const char *lon_name() { return "right_ascension"; }
  static constexpr const char *lat_name() { return "declination"; }
};

template <> struct SphericalNaming<EquatorialMeanJ2000> {
  static constexpr const char *lon_name() { return "right_ascension"; }
  static constexpr const char *lat_name() { return "declination"; }
};

template <> struct SphericalNaming<EquatorialMeanOfDate> {
  static constexpr const char *lon_name() { return "right_ascension"; }
  static constexpr const char *lat_name() { return "declination"; }
};

template <> struct SphericalNaming<EquatorialTrueOfDate> {
  static constexpr const char *lon_name() { return "right_ascension"; }
  static constexpr const char *lat_name() { return "declination"; }
};

template <> struct SphericalNaming<Horizontal> {
  static constexpr const char *lon_name() { return "azimuth"; }
  static constexpr const char *lat_name() { return "altitude"; }
};

template <> struct SphericalNaming<Galactic> {
  static constexpr const char *lon_name() { return "l"; }
  static constexpr const char *lat_name() { return "b"; }
};

template <> struct SphericalNaming<EclipticMeanJ2000> {
...
template <typename F> inline constexpr bool has_ra_dec_v = has_ra_dec<F>::value;
...
template <typename F> inline constexpr bool has_az_alt_v = has_az_alt<F>::value;
 ...
 */
template <typename F> struct has_horizontal_transform : std::false_type {};
